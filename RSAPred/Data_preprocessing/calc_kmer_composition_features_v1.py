...
with open(outpath + "Mononucleotide_v1.out", "w", encoding="utf-8") as f:
	comb_strs = []
...
with open(outpath+"Dinucleotide_v1.out", "w", encoding="utf-8") as f:
	comb_strs = []
...
with open(outpath+"Trinucleotide_v1.out", "w", encoding="utf-8") as f:
	comb_strs = []
...
with open(outpath+"Tetranucleotide_v1.out", "w", encoding="utf-8") as f:
	comb_strs = []
...
with open(outpath+"Pentanucleotide_v1.out", "w", encoding="utf-8") as f:
	comb_strs = []
...
with open(outpath+"Hexanucleotide_v1.out", "w", encoding="utf-8") as f:
	comb_strs = []
