###Analyzes PDB structures with ligands and counts the number of RNA vs Protein residues at various sphere radii.
###The output of this script can be used to select binding pockets.
### copied and modified from https://github.com/cgoliver/RNAmigos/blob/8a0dce5d456b9595f1c8456d21f0c921cc50c0aa/data_processor/binding_pocket_analyse.py
...
if __name__ == "__main__":
    ...
    process_all("pdb_rna_ligand_20220923_onlyrna/cif_test","pdb_rna_ligand_20220923_onlyrna/cif_test/test.p")