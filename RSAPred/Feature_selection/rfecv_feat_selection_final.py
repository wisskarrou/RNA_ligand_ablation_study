...
rfecv = RFECV(estimator=mlr, cv=3, scoring=pearson_r_scorer, verbose=1, n_jobs=-1)  #10-fold CV for feature selection using random forest
rfecv.fit(X_dataset, Y_dataset)

print("Optimal number of features: "+str(rfecv.n_features_))

with open(outfile, "wb") as f:
	pickle.dump(rfecv, file=f)
print("RFECV results pickled successfully.")

print("Number of features seen: "+str(rfecv.n_features_in_))
#print("Optimal number of features: "+str(rfecv.n_features_))
