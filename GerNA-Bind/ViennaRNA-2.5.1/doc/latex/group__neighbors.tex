...
\begin{DoxyItemize}
\item insertion\+: (i, j) where i,j \texorpdfstring{$>$}{>} 0 ~\newline

\item deletion\+: (i, j) where i,j \texorpdfstring{$<$}{<} 0 ~\newline
 shift\+: (i, j) where either i \texorpdfstring{$>$}{>} 0, j \texorpdfstring{$<$}{<} 0 or i \texorpdfstring{$<$}{<} 0, j \texorpdfstring{$>$}{>} 0 ~\newline
...
typedef struct \mbox{\hyperlink{group__neighbors_structvrna__move__s}{vrna\+\_\+move\+\_\+s}} {\bfseries vrna\+\_\+move\+\_\+t}
...
\mbox{\hyperlink{group__neighbors_ga08630e00206cd163ea29c462bf5f4755}{vrna\+\_\+move\+\_\+t}} $\ast$ {\bfseries next}
...
\mbox{\hyperlink{group__neighbors_ga4f8eefae08c05f5a49a4d4ee5d02e32f}{vrna\+\_\+neighbors()}}, \mbox{\hyperlink{group__neighbors_gade056be7557deeb3ba5c3989aa4feebf}{vrna\+\_\+neighbors\+\_\+successive}}, \mbox{\hyperlink{group__paths__walk_gaef7afadc36933b80706de49fe36e7b94}{vrna\+\_\+path()}} 
\end{DoxySeeAlso}
...
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
-\/1 if {\ttfamily a} \texorpdfstring{$<$}{<} {\ttfamily b}, 1 if {\ttfamily a} \texorpdfstring{$>$}{>} {\ttfamily b}, 0 otherwise 
\end{DoxyReturn}
...
Alters the loop\+Indices array that was constructed with \mbox{\hyperlink{group__struct__utils_ga8a2c825d6a9c2d73329b6c09320a6a90}{vrna\+\_\+loopidx\+\_\+from\+\_\+ptable()}}. 
...
\end{DoxyReturn}
\mbox{\Hypertarget{group__neighbors_ga7dde18e6f83355493cd698f07e259c75}\label{group__neighbors_ga7dde18e6f83355493cd698f07e259c75}} 
