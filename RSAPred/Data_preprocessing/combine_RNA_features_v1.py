...
mono_df.dropna(axis=1, how='any', subset=None, inplace=True)
di_df.dropna(axis=1, how='any', subset=None, inplace=True)
tri_df.dropna(axis=1, how='any', subset=None, inplace=True)
tetra_df.dropna(axis=1, how='any', subset=None, inplace=True)
ppseudoDNC_df.dropna(axis=1, how='any', subset=None, inplace=True)
triplet_df.dropna(axis=1, how='any', subset=None, inplace=True)
pseudo_struct_df.dropna(axis=1, how='any', subset=None, inplace=True)
