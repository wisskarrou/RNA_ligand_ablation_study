...
double {\bfseries Gikjl}
\begin{DoxyCompactList}\small\item\em full free energy for interaction between \mbox{[}k,i\mbox{]} k\texorpdfstring{$<$}{<}i in longer seq and \mbox{[}j,l\mbox{]} j\texorpdfstring{$<$}{<}l in shorter seq \end{DoxyCompactList}\item 
...
int {\bfseries i}
\begin{DoxyCompactList}\small\item\em k\texorpdfstring{$<$}{<}i in longer seq \end{DoxyCompactList}\item 
...
int {\bfseries j}
\begin{DoxyCompactList}\small\item\em j\texorpdfstring{$<$}{<}l in shorter seq \end{DoxyCompactList}\item 
...
double $\ast$$\ast$ {\bfseries u\+\_\+values}
...
\begin{DoxyNote}{Note}
If the symbol is present, the library was build with enabled C11/\+C++11 features support and no action is required. However, if the symbol is missing in RNAlib \texorpdfstring{$>$}{>}= 2.\+2.\+9, programs that link to RNAlib must define a pre-\/processor identifier {\itshape VRNA\+\_\+\+DISABLE\+\_\+\+C11\+\_\+\+FEATURES} before including any Vienna\+RNA Package header file, for instance by adding a {\itshape CPPFLAG} 
\begin{DoxyCode}{0}
