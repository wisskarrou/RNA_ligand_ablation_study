...
case $2 in
  --help)           no --show-help --set-version=2.5.1 < $1.ggo | grep -v "in doubt" | grep -v "Comments should be sent";;
  --version)        echo 2.5.1;;
  --detailed-help)  no --show-detailed-help --set-version=2.5.1 < $1.ggo | grep -v "in doubt" | grep -v "Comments should be sent";;
esac
