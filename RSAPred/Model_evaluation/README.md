...
## Alternative (to use txt files storing the raw fwatures as input instead of .log files)
```
* python test_on_regression_dataset_from_txt.py "./data/QSAR_dataset_final.csv" "../Feature_selection/data/Final_sample_dataset_v1.csv" <path of the features txt file> "test_results.csv"
* python test_on_classification_dataset_from_txt.py <positive dataset> <negative dataset> "../Feature_selection/data/Final_sample_dataset_v1.csv" <path of the features txt file>
```
