...
section "Core" sec_core
  ...
  File "/usr/i686-w64-mingw32/bin/libgcc_s_dw2-1.dll"
  File "/usr/i686-w64-mingw32/bin/libgsl-25.dll"
  ...
  File "/usr/i686-w64-mingw32/bin/libstdc++-6.dll"
