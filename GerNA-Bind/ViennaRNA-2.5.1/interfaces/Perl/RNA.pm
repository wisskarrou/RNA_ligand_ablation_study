...
*hx_from_ptable = *RNAc::hx_from_ptable;
...
*boustrophedon = *RNAc::boustrophedon;
...
############# Class : RNA::HelixVector ##############

package RNA::HelixVector;
use vars qw(@ISA %OWNER %ITERATORS %BLESSEDMEMBERS);
@ISA = qw( RNA );
%OWNER = ();
%ITERATORS = ();
sub new {
    my $pkg = shift;
    my $self = RNAc::new_HelixVector(@_);
    bless $self, $pkg if defined($self);
}

*size = *RNAc::HelixVector_size;
*empty = *RNAc::HelixVector_empty;
*clear = *RNAc::HelixVector_clear;
*push = *RNAc::HelixVector_push;
*pop = *RNAc::HelixVector_pop;
*get = *RNAc::HelixVector_get;
*set = *RNAc::HelixVector_set;
sub DESTROY {
    return unless $_[0]->isa('HASH');
    my $self = tied(%{$_[0]});
    return unless defined $self;
...
############# Class : RNA::varArrayUChar ##############

package RNA::varArrayUChar;
use vars qw(@ISA %OWNER %ITERATORS %BLESSEDMEMBERS);
@ISA = qw( RNA );
%OWNER = ();
%ITERATORS = ();
sub new {
    my $pkg = shift;
    my $self = RNAc::new_varArrayUChar(@_);
    bless $self, $pkg if defined($self);
}
...
sub DESTROY {
    ...
    delete $ITERATORS{$self};
    if (exists $OWNER{$self}) {
        RNAc::delete_varArrayUChar($self);
        delete $OWNER{$self};
    }
}

*__len__ = *RNAc::varArrayUChar___len__;
*__getitem__ = *RNAc::varArrayUChar___getitem__;
*__setitem__ = *RNAc::varArrayUChar___setitem__;
sub DISOWN {
    my $self = shift;
    my $ptr = tied(%$self);
    delete $OWNER{$ptr};
...
############# Class : RNA::varArrayChar ##############

package RNA::varArrayChar;
use vars qw(@ISA %OWNER %ITERATORS %BLESSEDMEMBERS);
@ISA = qw( RNA );
%OWNER = ();
%ITERATORS = ();
sub new {
    my $pkg = shift;
    my $self = RNAc::new_varArrayChar(@_);
    bless $self, $pkg if defined($self);
}
...
sub DESTROY {
    ...
    delete $ITERATORS{$self};
    if (exists $OWNER{$self}) {
        RNAc::delete_varArrayChar($self);
        delete $OWNER{$self};
    }
}

*__len__ = *RNAc::varArrayChar___len__;
*__getitem__ = *RNAc::varArrayChar___getitem__;
*__setitem__ = *RNAc::varArrayChar___setitem__;
sub DISOWN {
    my $self = shift;
    my $ptr = tied(%$self);
    delete $OWNER{$ptr};
...
############# Class : RNA::varArrayShort ##############

package RNA::varArrayShort;
use vars qw(@ISA %OWNER %ITERATORS %BLESSEDMEMBERS);
@ISA = qw( RNA );
%OWNER = ();
%ITERATORS = ();
sub DESTROY {
    ...
    delete $ITERATORS{$self};
    if (exists $OWNER{$self}) {
        RNAc::delete_varArrayShort($self);
        delete $OWNER{$self};
    }
}

*__len__ = *RNAc::varArrayShort___len__;
*__getitem__ = *RNAc::varArrayShort___getitem__;
*__setitem__ = *RNAc::varArrayShort___setitem__;
sub new {
    my $pkg = shift;
    my $self = RNAc::new_varArrayShort(@_);
    bless $self, $pkg if defined($self);
}
...
############# Class : RNA::varArrayUInt ##############

package RNA::varArrayUInt;
use vars qw(@ISA %OWNER %ITERATORS %BLESSEDMEMBERS);
@ISA = qw( RNA );
%OWNER = ();
%ITERATORS = ();
sub new {
    my $pkg = shift;
    my $self = RNAc::new_varArrayUInt(@_);
    bless $self, $pkg if defined($self);
}
...
sub DESTROY {
    ...
    delete $ITERATORS{$self};
    if (exists $OWNER{$self}) {
        RNAc::delete_varArrayUInt($self);
        delete $OWNER{$self};
    }
}

*__len__ = *RNAc::varArrayUInt___len__;
*__getitem__ = *RNAc::varArrayUInt___getitem__;
*__setitem__ = *RNAc::varArrayUInt___setitem__;
sub DISOWN {
    my $self = shift;
    my $ptr = tied(%$self);
    delete $OWNER{$ptr};
...
############# Class : RNA::varArrayInt ##############

package RNA::varArrayInt;
use vars qw(@ISA %OWNER %ITERATORS %BLESSEDMEMBERS);
@ISA = qw( RNA );
%OWNER = ();
%ITERATORS = ();
sub new {
    my $pkg = shift;
    my $self = RNAc::new_varArrayInt(@_);
    bless $self, $pkg if defined($self);
}
...
sub DESTROY {
    ...
    delete $ITERATORS{$self};
    if (exists $OWNER{$self}) {
        RNAc::delete_varArrayInt($self);
        delete $OWNER{$self};
    }
}

*__len__ = *RNAc::varArrayInt___len__;
*__getitem__ = *RNAc::varArrayInt___getitem__;
*__setitem__ = *RNAc::varArrayInt___setitem__;
sub DISOWN {
    my $self = shift;
    my $ptr = tied(%$self);
    delete $OWNER{$ptr};
...
############# Class : RNA::varArrayFLTorDBL ##############

package RNA::varArrayFLTorDBL;
use vars qw(@ISA %OWNER %ITERATORS %BLESSEDMEMBERS);
@ISA = qw( RNA );
%OWNER = ();
%ITERATORS = ();
sub new {
    my $pkg = shift;
    my $self = RNAc::new_varArrayFLTorDBL(@_);
    bless $self, $pkg if defined($self);
}
...
sub DESTROY {
    ...
    delete $ITERATORS{$self};
    if (exists $OWNER{$self}) {
        RNAc::delete_varArrayFLTorDBL($self);
        delete $OWNER{$self};
    }
}

*__len__ = *RNAc::varArrayFLTorDBL___len__;
*__getitem__ = *RNAc::varArrayFLTorDBL___getitem__;
*__setitem__ = *RNAc::varArrayFLTorDBL___setitem__;
sub DISOWN {
    my $self = shift;
    my $ptr = tied(%$self);
    delete $OWNER{$ptr};
...
%OWNER = ();
%ITERATORS = ();
*swig_start_get = *RNAc::hx_start_get;
*swig_start_set = *RNAc::hx_start_set;
*swig_end_get = *RNAc::hx_end_get;
*swig_end_set = *RNAc::hx_end_set;
*swig_length_get = *RNAc::hx_length_get;
*swig_length_set = *RNAc::hx_length_set;
*swig_up5_get = *RNAc::hx_up5_get;
*swig_up5_set = *RNAc::hx_up5_set;
*swig_up3_get = *RNAc::hx_up3_get;
*swig_up3_set = *RNAc::hx_up3_set;
sub new {
    my $pkg = shift;
    my $self = RNAc::new_hx(@_);
    bless $self, $pkg if defined($self);
}
...
%OWNER = ();
%ITERATORS = ();
*swig_type_get = *RNAc::hc_type_get;
*swig_type_set = *RNAc::hc_type_set;
*swig_n_get = *RNAc::hc_n_get;
*swig_n_set = *RNAc::hc_n_set;
*swig_mx_get = *RNAc::hc_mx_get;
*swig_mx_set = *RNAc::hc_mx_set;
*swig_up_ext_get = *RNAc::hc_up_ext_get;
*swig_up_ext_set = *RNAc::hc_up_ext_set;
*swig_up_hp_get = *RNAc::hc_up_hp_get;
*swig_up_hp_set = *RNAc::hc_up_hp_set;
*swig_up_int_get = *RNAc::hc_up_int_get;
*swig_up_int_set = *RNAc::hc_up_int_set;
*swig_up_ml_get = *RNAc::hc_up_ml_get;
*swig_up_ml_set = *RNAc::hc_up_ml_set;
sub new {
    my $pkg = shift;
    my $self = RNAc::new_hc(@_);
    bless $self, $pkg if defined($self);
}
...
*db_from_probs = *RNAc::fold_compound_db_from_probs;
...
*eval_ext_stem = *RNAc::fold_compound_eval_ext_stem;
...
*exp_E_ext_stem = *RNAc::fold_compound_exp_E_ext_stem;
...
*zsc_compute_raw = *RNAc::fold_compound_zsc_compute_raw;
...
*pbacktrack_sub = *RNAc::fold_compound_pbacktrack_sub;
...
*swig_sequence_get = *RNAc::fold_compound_sequence_get;
*swig_sequence_set = *RNAc::fold_compound_sequence_set;
...
*swig_matrices_get = *RNAc::fold_compound_matrices_get;
*swig_matrices_set = *RNAc::fold_compound_matrices_set;
*swig_exp_matrices_get = *RNAc::fold_compound_exp_matrices_get;
*swig_exp_matrices_set = *RNAc::fold_compound_exp_matrices_set;
*swig_hc_get = *RNAc::fold_compound_hc_get;
*swig_hc_set = *RNAc::fold_compound_hc_set;
*swig_strand_number_get = *RNAc::fold_compound_strand_number_get;
*swig_strand_number_set = *RNAc::fold_compound_strand_number_set;
*swig_strand_order_get = *RNAc::fold_compound_strand_order_get;
*swig_strand_order_set = *RNAc::fold_compound_strand_order_set;
*swig_strand_start_get = *RNAc::fold_compound_strand_start_get;
*swig_strand_start_set = *RNAc::fold_compound_strand_start_set;
*swig_strand_end_get = *RNAc::fold_compound_strand_end_get;
*swig_strand_end_set = *RNAc::fold_compound_strand_end_set;
*swig_iindx_get = *RNAc::fold_compound_iindx_get;
*swig_iindx_set = *RNAc::fold_compound_iindx_set;
*swig_jindx_get = *RNAc::fold_compound_jindx_get;
*swig_jindx_set = *RNAc::fold_compound_jindx_set;
*swig_sequence_encoding_get = *RNAc::fold_compound_sequence_encoding_get;
*swig_sequence_encoding_set = *RNAc::fold_compound_sequence_encoding_set;
*swig_sequence_encoding2_get = *RNAc::fold_compound_sequence_encoding2_get;
*swig_sequence_encoding2_set = *RNAc::fold_compound_sequence_encoding2_set;
sub new {
    my $pkg = shift;
...
%OWNER = ();
%ITERATORS = ();
*swig_type_get = *RNAc::mx_mfe_type_get;
*swig_type_set = *RNAc::mx_mfe_type_set;
*swig_length_get = *RNAc::mx_mfe_length_get;
*swig_length_set = *RNAc::mx_mfe_length_set;
*swig_strands_get = *RNAc::mx_mfe_strands_get;
*swig_strands_set = *RNAc::mx_mfe_strands_set;
*swig_f5_get = *RNAc::mx_mfe_f5_get;
*swig_f5_set = *RNAc::mx_mfe_f5_set;
*swig_f3_get = *RNAc::mx_mfe_f3_get;
*swig_f3_set = *RNAc::mx_mfe_f3_set;
*swig_c_get = *RNAc::mx_mfe_c_get;
*swig_c_set = *RNAc::mx_mfe_c_set;
*swig_fML_get = *RNAc::mx_mfe_fML_get;
*swig_fML_set = *RNAc::mx_mfe_fML_set;
*swig_fM1_get = *RNAc::mx_mfe_fM1_get;
*swig_fM1_set = *RNAc::mx_mfe_fM1_set;
*swig_fM2_get = *RNAc::mx_mfe_fM2_get;
*swig_fM2_set = *RNAc::mx_mfe_fM2_set;
*swig_ggg_get = *RNAc::mx_mfe_ggg_get;
*swig_ggg_set = *RNAc::mx_mfe_ggg_set;
*swig_Fc_get = *RNAc::mx_mfe_Fc_get;
*swig_Fc_set = *RNAc::mx_mfe_Fc_set;
*swig_FcH_get = *RNAc::mx_mfe_FcH_get;
*swig_FcH_set = *RNAc::mx_mfe_FcH_set;
*swig_FcI_get = *RNAc::mx_mfe_FcI_get;
*swig_FcI_set = *RNAc::mx_mfe_FcI_set;
*swig_FcM_get = *RNAc::mx_mfe_FcM_get;
*swig_FcM_set = *RNAc::mx_mfe_FcM_set;
sub new {
    my $pkg = shift;
    my $self = RNAc::new_mx_mfe(@_);
    bless $self, $pkg if defined($self);
}
...
%OWNER = ();
%ITERATORS = ();
*swig_type_get = *RNAc::mx_pf_type_get;
*swig_type_set = *RNAc::mx_pf_type_set;
*swig_length_get = *RNAc::mx_pf_length_get;
*swig_length_set = *RNAc::mx_pf_length_set;
*swig_scale_get = *RNAc::mx_pf_scale_get;
*swig_scale_set = *RNAc::mx_pf_scale_set;
*swig_expMLbase_get = *RNAc::mx_pf_expMLbase_get;
*swig_expMLbase_set = *RNAc::mx_pf_expMLbase_set;
*swig_q_get = *RNAc::mx_pf_q_get;
*swig_q_set = *RNAc::mx_pf_q_set;
*swig_qb_get = *RNAc::mx_pf_qb_get;
*swig_qb_set = *RNAc::mx_pf_qb_set;
*swig_qm_get = *RNAc::mx_pf_qm_get;
*swig_qm_set = *RNAc::mx_pf_qm_set;
*swig_qm1_get = *RNAc::mx_pf_qm1_get;
*swig_qm1_set = *RNAc::mx_pf_qm1_set;
*swig_probs_get = *RNAc::mx_pf_probs_get;
*swig_probs_set = *RNAc::mx_pf_probs_set;
*swig_q1k_get = *RNAc::mx_pf_q1k_get;
*swig_q1k_set = *RNAc::mx_pf_q1k_set;
*swig_qln_get = *RNAc::mx_pf_qln_get;
*swig_qln_set = *RNAc::mx_pf_qln_set;
*swig_G_get = *RNAc::mx_pf_G_get;
*swig_G_set = *RNAc::mx_pf_G_set;
*swig_qo_get = *RNAc::mx_pf_qo_get;
*swig_qo_set = *RNAc::mx_pf_qo_set;
*swig_qm2_get = *RNAc::mx_pf_qm2_get;
*swig_qm2_set = *RNAc::mx_pf_qm2_set;
*swig_qho_get = *RNAc::mx_pf_qho_get;
*swig_qho_set = *RNAc::mx_pf_qho_set;
*swig_qio_get = *RNAc::mx_pf_qio_get;
*swig_qio_set = *RNAc::mx_pf_qio_set;
*swig_qmo_get = *RNAc::mx_pf_qmo_get;
*swig_qmo_set = *RNAc::mx_pf_qmo_set;
sub new {
    my $pkg = shift;
    my $self = RNAc::new_mx_pf(@_);
    bless $self, $pkg if defined($self);
}
...
package RNA;
sub VAR_ARRAY_LINEAR () { $RNAc::VAR_ARRAY_LINEAR }
sub VAR_ARRAY_TRI () { $RNAc::VAR_ARRAY_TRI }
sub VAR_ARRAY_SQR () { $RNAc::VAR_ARRAY_SQR }
sub VAR_ARRAY_ONE_BASED () { $RNAc::VAR_ARRAY_ONE_BASED }
sub VAR_ARRAY_OWNED () { $RNAc::VAR_ARRAY_OWNED }
...
sub TRIM_LEADING () { $RNAc::TRIM_LEADING }
sub TRIM_TRAILING () { $RNAc::TRIM_TRAILING }
sub TRIM_IN_BETWEEN () { $RNAc::TRIM_IN_BETWEEN }
sub TRIM_DEFAULT () { $RNAc::TRIM_DEFAULT }
sub TRIM_ALL () { $RNAc::TRIM_ALL }
...
sub PLIST_TYPE_UNPAIRED () { $RNAc::PLIST_TYPE_UNPAIRED }
