...
\DoxyCodeLine{  \textcolor{keywordtype}{char}  *structure = (\textcolor{keywordtype}{char} *)\mbox{\hyperlink{group__utils_gafae44c31c8772450d6c674a582be3e3c}{vrna\_alloc}}(\textcolor{keyword}{sizeof}(\textcolor{keywordtype}{char}) * (strlen(seq) + 1));}
\DoxyCodeLine{}
...
\DoxyCodeLine{  \textcolor{keywordtype}{char}        *structure = (\textcolor{keywordtype}{char} *)\mbox{\hyperlink{group__utils_gafae44c31c8772450d6c674a582be3e3c}{vrna\_alloc}}(\textcolor{keyword}{sizeof}(\textcolor{keywordtype}{char}) * (strlen(sequences[0]) + 1));}
\DoxyCodeLine{}
\DoxyCodeLine{  \textcolor{comment}{/* predict Minmum Free Energy and corresponding secondary structure */}}
...
\DoxyCodeLine{  \textcolor{keywordtype}{char}      *propensity = (\textcolor{keywordtype}{char} *)\mbox{\hyperlink{group__utils_gafae44c31c8772450d6c674a582be3e3c}{vrna\_alloc}}(\textcolor{keyword}{sizeof}(\textcolor{keywordtype}{char}) * (strlen(seq) + 1));}
\DoxyCodeLine{}
...
\DoxyCodeLine{  \textcolor{keywordtype}{char}                  *seq = \mbox{\hyperlink{group__string__utils_gab4714ab789de302ee19e0e7ea0766a3e}{vrna\_random\_string}}(50, \textcolor{stringliteral}{"{}ACGU"{}});}
\DoxyCodeLine{}
\DoxyCodeLine{  \textcolor{comment}{/* Create a fold compound for the sequence */}}
\DoxyCodeLine{  \mbox{\hyperlink{group__fold__compound_structvrna__fc__s}{vrna\_fold\_compound\_t}}  *fc = \mbox{\hyperlink{group__fold__compound_gab89fe9844031711d42c70d1b9277c0d5}{vrna\_fold\_compound}}(seq, NULL, \mbox{\hyperlink{group__fold__compound_gacea5b7ee6181c485f36e2afa0e9089e4}{VRNA\_OPTION\_DEFAULT}});}
\DoxyCodeLine{}
\DoxyCodeLine{  \textcolor{comment}{/* allocate memory for MFE structure (length + 1) */}}
\DoxyCodeLine{  \textcolor{keywordtype}{char}                  *structure = (\textcolor{keywordtype}{char} *)\mbox{\hyperlink{group__utils_gafae44c31c8772450d6c674a582be3e3c}{vrna\_alloc}}(\textcolor{keyword}{sizeof}(\textcolor{keywordtype}{char}) * (strlen(seq) + 1));}
\DoxyCodeLine{}
...
\DoxyCodeLine{  \mbox{\hyperlink{group__fold__compound_structvrna__fc__s}{vrna\_fold\_compound\_t}}  *fc = \mbox{\hyperlink{group__fold__compound_gab89fe9844031711d42c70d1b9277c0d5}{vrna\_fold\_compound}}(seq, \&md, \mbox{\hyperlink{group__fold__compound_gacea5b7ee6181c485f36e2afa0e9089e4}{VRNA\_OPTION\_DEFAULT}});}
\DoxyCodeLine{}
\DoxyCodeLine{  \textcolor{comment}{/* predict Minmum Free Energy and corresponding secondary structure */}}
\DoxyCodeLine{  \textcolor{keywordtype}{float}                 mfe = \mbox{\hyperlink{group__mfe__global_gabd3b147371ccf25c577f88bbbaf159fd}{vrna\_mfe}}(fc, structure);}
\DoxyCodeLine{}
...
\DoxyCodeLine{\textcolor{comment}{   */}}
\DoxyCodeLine{  \mbox{\hyperlink{group__subopt__wuchty_gaa9c6b75ecb478d87fae4bd42c40d7c11}{vrna\_subopt\_cb}}(fc, 500, \&subopt\_callback, (\textcolor{keywordtype}{void} *)\&counter);}
\DoxyCodeLine{}
\DoxyCodeLine{  \textcolor{comment}{/* cleanup memory */}}
\DoxyCodeLine{  free(seq);}
\DoxyCodeLine{  \mbox{\hyperlink{group__fold__compound_ga576a077b418a9c3650e06f8e5d296fc2}{vrna\_fold\_compound\_free}}(fc);}
...
\DoxyCodeLine{}
\DoxyCodeLine{  \textcolor{comment}{/* allocate memory for MFE structure (length + 1) */}}
\DoxyCodeLine{  \textcolor{keywordtype}{char}  *structure = (\textcolor{keywordtype}{char} *)\mbox{\hyperlink{group__utils_gafae44c31c8772450d6c674a582be3e3c}{vrna\_alloc}}(\textcolor{keyword}{sizeof}(\textcolor{keywordtype}{char}) * 51);}
\DoxyCodeLine{}
\DoxyCodeLine{  \textcolor{comment}{/* predict Minmum Free Energy and corresponding secondary structure */}}
\DoxyCodeLine{  \textcolor{keywordtype}{float} mfe = \mbox{\hyperlink{group__mfe__global_gabd3b147371ccf25c577f88bbbaf159fd}{vrna\_mfe}}(fc, structure);}
\DoxyCodeLine{}
...
\DoxyCodeLine{  \textcolor{keywordtype}{char}                  *mfe\_structure  = \mbox{\hyperlink{group__utils_gafae44c31c8772450d6c674a582be3e3c}{vrna\_alloc}}(\textcolor{keyword}{sizeof}(\textcolor{keywordtype}{char}) * (strlen(seq) + 1));}
\DoxyCodeLine{  \textcolor{keywordtype}{char}                  *prob\_string    = \mbox{\hyperlink{group__utils_gafae44c31c8772450d6c674a582be3e3c}{vrna\_alloc}}(\textcolor{keyword}{sizeof}(\textcolor{keywordtype}{char}) * (strlen(seq) + 1));}
\DoxyCodeLine{}
\DoxyCodeLine{  \textcolor{comment}{/* get a vrna\_fold\_compound with default settings */}}
\DoxyCodeLine{  \mbox{\hyperlink{group__fold__compound_structvrna__fc__s}{vrna\_fold\_compound\_t}}  *vc = \mbox{\hyperlink{group__fold__compound_gab89fe9844031711d42c70d1b9277c0d5}{vrna\_fold\_compound}}(seq, NULL, \mbox{\hyperlink{group__fold__compound_gacea5b7ee6181c485f36e2afa0e9089e4}{VRNA\_OPTION\_DEFAULT}});}
\DoxyCodeLine{}
...
\DoxyCodeLine{  \textcolor{keywordtype}{char}    *cent = \mbox{\hyperlink{group__centroid__fold_ga30b00b490a6d7711d487b213aa9ff366}{vrna\_centroid}}(vc, \&dist);}
\DoxyCodeLine{}
\DoxyCodeLine{  \textcolor{comment}{/* print centroid structure, its free energy and mean distance to the ensemble */}}
\DoxyCodeLine{  printf(\textcolor{stringliteral}{"{}\%s (\%6.2f d=\%6.2f)\(\backslash\)n"{}}, cent, \mbox{\hyperlink{group__eval_ga06985672a4c73f0e56e1c5722e0aa88e}{vrna\_eval\_structure}}(vc, cent), dist);}
\DoxyCodeLine{}
...
\DoxyCodeLine{  struct1 = (\textcolor{keywordtype}{char} *)\mbox{\hyperlink{utils_2basic_8h_a83f2f6369766056d7a146f36a7c9682d}{space}}(\textcolor{keyword}{sizeof}(\textcolor{keywordtype}{char}) * (strlen(seq1) + 1));}
\DoxyCodeLine{  e1      = \mbox{\hyperlink{group__mfe__global__deprecated_gaadafcb0f140795ae62e5ca027e335a9b}{fold}}(seq1, struct1);}
\DoxyCodeLine{}
\DoxyCodeLine{  struct2 = (\textcolor{keywordtype}{char} *)\mbox{\hyperlink{utils_2basic_8h_a83f2f6369766056d7a146f36a7c9682d}{space}}(\textcolor{keyword}{sizeof}(\textcolor{keywordtype}{char}) * (strlen(seq2) + 1));}
...
\DoxyCodeLine{  xstruc  = \mbox{\hyperlink{group__struct__utils__deprecated_ga6eea10bca410a57aaffcdea7bcf89bda}{expand\_Full}}(struct1);}
\DoxyCodeLine{  T1      = \mbox{\hyperlink{treedist_8h_a0991c4fa794283a70c1bef0d626d5721}{make\_tree}}(xstruc);}
\DoxyCodeLine{  S1      = \mbox{\hyperlink{stringdist_8h_a3d651eb191423401b816d0f0639d42c2}{Make\_swString}}(xstruc);}
\DoxyCodeLine{  free(xstruc);}
\DoxyCodeLine{}
\DoxyCodeLine{  xstruc  = \mbox{\hyperlink{group__struct__utils__deprecated_ga6eea10bca410a57aaffcdea7bcf89bda}{expand\_Full}}(struct2);}
\DoxyCodeLine{  T2      = \mbox{\hyperlink{treedist_8h_a0991c4fa794283a70c1bef0d626d5721}{make\_tree}}(xstruc);}
\DoxyCodeLine{  S2      = \mbox{\hyperlink{stringdist_8h_a3d651eb191423401b816d0f0639d42c2}{Make\_swString}}(xstruc);}
\DoxyCodeLine{  free(xstruc);}
\DoxyCodeLine{}
...
\DoxyCodeLine{  bppm  = \mbox{\hyperlink{group__part__func__global__deprecated_gad2bba2bdfef5a24f69fe10bbb9fc6de9}{export\_bppm}}();}
\DoxyCodeLine{  pf1   = \mbox{\hyperlink{profiledist_8h_a512ae37eed5828cc1cd3fcb9ce2326a2}{Make\_bp\_profile\_bppm}}(bppm, strlen(seq1));}
\DoxyCodeLine{}
...
\DoxyCodeLine{  \textcolor{comment}{/* get the base pair probability matrix for the previous run of pf\_fold() */}}
\DoxyCodeLine{  bppm  = \mbox{\hyperlink{group__part__func__global__deprecated_gad2bba2bdfef5a24f69fe10bbb9fc6de9}{export\_bppm}}();}
\DoxyCodeLine{  pf2   = \mbox{\hyperlink{profiledist_8h_a512ae37eed5828cc1cd3fcb9ce2326a2}{Make\_bp\_profile\_bppm}}(bppm, strlen(seq2));}
\DoxyCodeLine{}
...
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{comment}{\# print output}}
\DoxyCodeLine{print(\textcolor{stringliteral}{"{}\{\} [ \{:6.2f\} ]"{}}.format(ss, mfe))}
...
\DoxyCodeLine{        print(\textcolor{stringliteral}{"{}>subopt \{:d\}"{}}.format(data[\textcolor{stringliteral}{'counter'}]))}
\DoxyCodeLine{        print(\textcolor{stringliteral}{"{}\{\}\(\backslash\)n\{\} [\{:6.2f\}]"{}}.format(data[\textcolor{stringliteral}{'sequence'}], structure, energy))}
...
\DoxyCodeLine{\textcolor{stringliteral}{    "{}"{}"{}}}
\DoxyCodeLine{\textcolor{stringliteral}{    }\textcolor{keywordflow}{if} s:}
...
\DoxyCodeLine{print(\textcolor{stringliteral}{"{}\{\}"{}}.format(fc.pbacktrack5(10)))}
\DoxyCodeLine{}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{comment}{\# 2. backtrace a single sub-\/structure of length 50}}
\DoxyCodeLine{print(\textcolor{stringliteral}{"{}\{\}"{}}.format(fc.pbacktrack5(50)))}
\DoxyCodeLine{}
...
\DoxyCodeLine{    print(\textcolor{stringliteral}{"{}\{\}"{}}.format(s))}
\DoxyCodeLine{}
...
\DoxyCodeLine{print(\textcolor{stringliteral}{"{}\{\}"{}}.format(fc.pbacktrack()))}
\DoxyCodeLine{}
...
\DoxyCodeLine{    print(\textcolor{stringliteral}{"{}\{\}"{}}.format(s))}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{comment}{\# 13. backtrace a single substructure from the sequence interval [10:50]}}
\DoxyCodeLine{print(\textcolor{stringliteral}{"{}\{\}"{}}.format(fc.pbacktrack\_sub(10, 50)))}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{comment}{\# 14. backtrace multiple substructures from the sequence interval [10:50]}}
\DoxyCodeLine{\textcolor{keywordflow}{for} s \textcolor{keywordflow}{in} fc.pbacktrack\_sub(100, 10, 50):}
\DoxyCodeLine{    print(\textcolor{stringliteral}{"{}\{\}"{}}.format(s))}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{comment}{\# 15. backtrace multiple substructures from the sequence interval [10:50] non-\/redundantly}}
\DoxyCodeLine{\textcolor{keywordflow}{for} s \textcolor{keywordflow}{in} fc.pbacktrack\_sub(100, 10, 50, RNA.PBACKTRACK\_NON\_REDUNDANT):}
\DoxyCodeLine{    print(\textcolor{stringliteral}{"{}\{\}"{}}.format(s))}
...
\DoxyCodeLine{print(\textcolor{stringliteral}{"{}\{\}\(\backslash\)n\{\} (\{:6.2f\})"{}}.format(seq, mfe\_struct, mfe))}
\DoxyCodeLine{print(\textcolor{stringliteral}{"{}\{\} [\{:6.2f\}]"{}}.format(pp, pf))}
\DoxyCodeLine{print(\textcolor{stringliteral}{"{}\{\} \{\{\{:6.2f\} d=\{:.2f\}\}\}"{}}.format(centroid\_struct, centroid\_en, dist))}
\DoxyCodeLine{print(\textcolor{stringliteral}{"{}\{\} \{\{\{:6.2f\} MEA=\{:.2f\}\}\}"{}}.format(MEA\_struct, MEA\_en, MEA))}
\DoxyCodeLine{print(\textcolor{stringliteral}{"{} frequency of mfe structure in ensemble \{:g\}; ensemble diversity \{:-\/6.2f\}"{}}.format(fc.pr\_structure(mfe\_struct), fc.mean\_bp\_distance()))}
...
\DoxyCodeLine{    RNA.DECOMP\_EXT\_STEM:      \textcolor{keyword}{lambda} i, j, k, l, f, p: -\/ f.eval\_ext\_stem(k, l),}
\DoxyCodeLine{    RNA.DECOMP\_EXT\_EXT:       \textcolor{keyword}{lambda} i, j, k, l, f, p: 0,}
\DoxyCodeLine{    RNA.DECOMP\_EXT\_STEM\_EXT:  \textcolor{keyword}{lambda} i, j, k, l, f, p: -\/ f.eval\_ext\_stem(i, k),}
\DoxyCodeLine{    RNA.DECOMP\_EXT\_EXT\_STEM:  \textcolor{keyword}{lambda} i, j, k, l, f, p: -\/ f.eval\_ext\_stem(l, j),}
\DoxyCodeLine{            \}}
\DoxyCodeLine{}
...
\DoxyCodeLine{print(\textcolor{stringliteral}{"{}\{\}\(\backslash\)n\{\} (MM: \{:d\})"{}}.format(seq1, s, int(-\/mm)))}
\DoxyCodeLine{}
