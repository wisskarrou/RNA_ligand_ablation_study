...
\item Contributors License Agreement (CLA)
\end{DoxyItemize}

\doxysection*{General Remarks}

The Vienna\+RNA Package is developed by humans and consequently may contain bugs that prevent proper operation of the implemented algorithms. If you think you have found any of those nasty animals, please help us to improve our software by reporting the bug to us.
...
More importantly, if you wish to contribute any files or software, you need to agree to our Vienna\+RNA Package Contributors License Agreement (CLA)! Otherwise, your contributions can\textquotesingle{}t be merged into our source tree. See below for further information and the full CLA details.
